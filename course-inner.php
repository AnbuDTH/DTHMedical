...
<!DOCTYPE html>
   ...
   include('config.php');
$k="select * from courses where id='".$_GET['id']."'";		
...
<title>NPTEL :: <?php echo $k2['course']; ?> - <?php echo $k2['subname']; ?></title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;"><?php echo $k2['course']; ?></a></li>
				  <li><a href="#" style="cursor: default;"><?php echo $k2['subname']; ?>&nbsp;(<?php echo $k2['content']; ?>)&nbsp;</a></li>
					<!-- <li><a href='content/syllabus_pdf/127106134.php' target='_blank'><b>Syllabus</b></a></li>	-->			  
					 
					 <li><a href="#" style="cursor: default;">Co-ordinated by : <span style="color:#7f0804;"><?php echo $k2['coordinatedby']; ?></span></a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy."><?php echo $k2['course']; ?></a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'ZTu8OHlpJw0')";
									 ><?php echo $k2['subname']; ?></a></li>	
			 ...
			 <div class="col-md-8">
              ...
              <div id="myiframe">
				...
				<div class="tab-content video-contents">
					<?php if($k2['videoAvailableForPublic'] == 'Yes') { ?>
						<!-- youtube video start-->
						<div id="watch" class="tab-pane active">
					      		<iframe width="570" height="380" id="utubeframe"src="<?php echo $k2['videourl']; ?>" allowfullscreen></iframe>
					     </div>
					  	<!-- youtube video end -->
						...
						<!-- download notes end -->
					<?php } else { ?>
						<div class="notAvailableText"> Pathology lectures will be reuploaded with some editing which has been suggested by the National Coordinators.</div>
					<?php } ?>
				</div>
