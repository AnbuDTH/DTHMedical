...
<title>NPTEL ::	MICROBIOLOGY - Immunology in the diagnosis of Bacterial diseases & Molecular diagnosis.
 (Indirect Methods) </title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Microbiology</a></li>
				  <li><a href="#" style="cursor: default;">Immunology in the diagnosis of Bacterial diseases & Molecular diagnosis.
 (Indirect Methods) &nbsp;(Video)&nbsp;</a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy.">	MICROBIOLOGY</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'fqyn3jg_mMI')";
									 >Immunology in the diagnosis of Bacterial diseases & Molecular diagnosis.
 (Indirect Methods) </a></li>	
...
<div class="tab-content video-contents">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/fqyn3jg_mMI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
