...
<title>NPTEL ::	MICROBIOLOGY - Viral Diarrhea </title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Viral Diarrhea &nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="560" height="315" src="https://www.youtube.com/embed/mZd8DEAq1Vs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</iframe>
      </div>
  <!-- youtube video end -->
