...
<title>NPTEL ::	MICROBIOLOGY - Parasites infecting the CNS </title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Parasites infecting the CNS &nbsp;(Video)&nbsp;</a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy.">	MICROBIOLOGY</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'NdN77OBzusE')";
									 >Parasites infecting the CNS </a></li>	
...
<div class="tab-content video-contents">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/NdN77OBzusE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
