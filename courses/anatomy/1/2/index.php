...
<title>NPTEL :: Anatomy - Hip Joint</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Hip Joint&nbsp;(Video)&nbsp;</a></li>
			...
			<!---	<li><a href="#" style="cursor: default;">Available from : <span style="color:#7f0804;">2019-08-01</span></a></li>
				...
				<li><a href="#" style="cursor: default;">Lec :<span style="coloHip Jointr:#7f0804;" id="lecid">1</span></a></li>   ----->
			  </ul>
		</div>
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe"src="https://www.youtube.com/embed/9xtks2kso78" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
