...
<title>NPTEL :: Anatomy -Knee joint</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Knee joint&nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe" src="https://www.youtube.com/embed/QP9tZaVwWjw" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
  <!-- download notes start-->
	 <div id="downloads" class="tab-pane fade">
			...
			<div id='tab3' class='tab-pane fade '><table class='table'><thead> 
			<th>Module Name</th><th>Download</th></thead><tbody></tbody></table></div> 
		</div>
			 	 </div>
	<!-- download notes end -->
