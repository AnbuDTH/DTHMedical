...
<title>NPTEL :: Anatomy - Abdominal aorta & inferior vena cava</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Abdominal aorta & inferior vena cava&nbsp;(Video)&nbsp;</a></li>
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					...
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy.">Anatomy</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'ZTu8OHlpJw0')";
									 >Abdominal aorta & inferior vena cava</a></li>	
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe"src="https://www.youtube.com/embed/3JvcnJfPsO0" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
