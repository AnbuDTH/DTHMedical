...
<title>NPTEL :: Anatomy - Thyroid gland</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Thyroid gland&nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe"src="https://www.youtube.com/embed/at2_7X9aQz8" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
