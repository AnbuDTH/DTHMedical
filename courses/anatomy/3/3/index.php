...
<title>NPTEL :: Anatomy - Lungs</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Lungs&nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	<!-- youtube video start-->
<iframe width="560" height="315" src="https://www.youtube.com/embed/-Hr8McsTGFM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
