...
<title>NPTEL :: Anatomy - Palmar spaces</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Palmar spaces&nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	<!-- youtube video start-->
<iframe width="560" height="315" src="https://www.youtube.com/embed/X_4Te0aygB8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
