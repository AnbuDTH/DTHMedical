...
<title>NPTEL :: Biochemistry - Application of structural knowledge of hemoglobin in understanding the genetics and pathogenesis of major hemoglobinopathies</title>
...
<nav class="navbar navbar-inverse">
      <div class="head-container navcontrol">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../../../../index.php"><img src="../../../../assets/nptel_assets/images/sp-logo.png" class="img-responsive nptellogo" style="margin-top: 0px;height:120px;"></a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <div class="right">
            ...
            <a class="navbar-brand" style="margin-right: -72px;" href="../../../../index.php"><img src="../../../../assets/nptel_assets/images/iitlogo.png" class="img-responsive "></a>
          </div>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Biochemistry</a></li>
				  <li><a href="#" style="cursor: default;">Application of structural knowledge of hemoglobin in understanding the genetics and pathogenesis of major hemoglobinopathies&nbsp;(Video)&nbsp;</a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Biochemistry.">Biochemistry</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'coIY4reMxKA')";
									 >Application of structural knowledge of hemoglobin in understanding the genetics and pathogenesis of major hemoglobinopathies</a></li>	
...
<div class="tab-content video-contents">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/coIY4reMxKA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
