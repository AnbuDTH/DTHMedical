...
<title>NPTEL :PATHOLOGY - Inflammation-2  2.2</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Inflammation-2  2.2&nbsp;(Video)&nbsp;</a></li>
...
<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe"src="https://www.youtube.com/embed/cgnD7y2RmPU" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
