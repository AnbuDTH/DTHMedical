...
<title>NPTEL :PATHOLOGY - Urinary System Introduction & General Consideration
</title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Urinary System Introduction & General Consideration
&nbsp;(Video)&nbsp;</a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy.">	PATHOLOGY</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'AHXLwdDu0UY')";
									 >Urinary System Introduction & General Consideration
</a></li>	
...
<div class="tab-content video-contents">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/qYmCaWqfbhc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
  <!-- youtube video end -->
