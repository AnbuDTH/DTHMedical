...
<title>NPTEL : PHYSIOLOGY - GP-5 Membrane Transport: Facilitated diffusion </title>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">GP-5 Membrane Transport: Facilitated diffusion&nbsp;(Video)&nbsp;</a></li>
		...
		<div id="contentContainer" class="col-md-12 coursedetails_area">
			...
			<div class="col-md-4 course_lectures">
				...
				<div class="" id="div_lm">
					<ul>
					<li class="first"><a style=border:none class="header" href="#" title=".Anatomy.">PHYSIOLOGY</a><ul><li class=here  id=lec1><a style=border:none href="" class="header" 									onclick ="change_video_path(1,'t6SbHs7g-iw')";
									 >GP-5 Membrane Transport: Facilitated diffusion</a></li>	
...
<div class="tab-content video-contents">
	...
	<div id="watch" class="tab-pane active">
      		<iframe width="570" height="380" id="utubeframe"src="https://www.youtube.com/embed/t6SbHs7g-iw" allowfullscreen>
		</iframe>
      </div>
  <!-- youtube video end -->
