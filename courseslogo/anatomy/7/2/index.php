...
<title>NPTEL :: Anatomy - Inguinal canal</title>
	...
	<nav class="navbar navbar-inverse">
      <div class="head-container navcontrol">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../../../../index.php"><img src="../../../../assets/nptel_assets/images/nptel-logo.png" class="img-responsive nptellogo"></a>
        </div>
	...
	<div class="container">
  		<div class="col-md-12">
			<ul id="breadcrumbs-course">
				  ...
				  <li><a href="#" style="cursor: default;">Inguinal canal&nbsp;(Video)&nbsp;</a></li>
...
<div class="tab-content video-contents">
	<!-- youtube video start-->
<iframe width="560" height="315" src="https://www.youtube.com/embed/SBqYa67ncLQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>  </div>
  <!-- youtube video end -->
